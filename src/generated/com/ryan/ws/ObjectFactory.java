 ...
 * generated in the com.ryan.ws package. 
...
public class ObjectFactory {
    ...
    private final static QName _CalculateSum_QNAME = new QName("http://ws.ryan.com/", "calculateSum");
    private final static QName _CalculateSumResponse_QNAME = new QName("http://ws.ryan.com/", "calculateSumResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.ryan.ws
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.ryan.com/", name = "calculateSum")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.ryan.com/", name = "calculateSumResponse")
